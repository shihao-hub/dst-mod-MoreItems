...
local function fn()
    ...
    if not TheWorld.ismastersim then
        ...
        inst.OnEntityReplicated = function(inst)
            ...
            if inst and inst.replica and inst.replica.container then
                inst.replica.container:WidgetSetup("mone_icebox");
            end
        end
        return inst
    end
    ...
    inst.components.container:WidgetSetup("mone_icebox")
...
return Prefab("mone_icebox", fn, assets, prefabs),
MakePlacer("mone_icebox_placer", "icebox", "ice_box", "closed")
