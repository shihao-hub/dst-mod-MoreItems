...
local function waterballoon_fn()
    ...
    inst.components.inventoryitem:ChangeImageName("waterballoon");
...
return
--Prefab("snowball", snowball_fn, snowball_assets, snowball_prefabs),
Prefab("mone_waterballoon", waterballoon_fn, waterballoon_assets, waterballoon_prefabs)
