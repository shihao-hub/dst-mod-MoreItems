...
local function fn()
    ...
    if not TheWorld.ismastersim then
        ...
        inst.OnEntityReplicated = function(inst)
            ...
            if inst and inst.replica and inst.replica.container then
                inst.replica.container:WidgetSetup("mone_saltbox");
            end
        end
        return inst
    end
    ...
    inst.components.container:WidgetSetup("mone_saltbox")
...
return Prefab("mone_saltbox", fn, assets, prefabs),
MakePlacer("mone_saltbox_placer", "saltbox", "saltbox", "closed")